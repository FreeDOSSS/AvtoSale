...
const App= () => {
  ...
  return (
    <>
      <Head>
        <title>Автовыкуп в Донецке. Работаем 24/7. Даем 95% рыночной цены</title>
        <link rel="canonical" href="https://vykup.org/avtovykyp-donetsk" />
        <meta name="description" content="Автовыкуп в Донецке. Выкупим ваше авто по самой высокой цене быстро! Все виды оплат. Безопасная сделка, бесплатная оценка авто.  Платим сразу всю сумму. Работаем быстро." />
        <meta property="og:title" content="Автовыкуп в Донецке. Работаем 24/7. Даем 95% рыночной цены" />
        <meta property="og:type" content="website" />
        <meta property = "og:url" content="https://vykup.org/avtovykyp-donetsk" />
        <meta property="og:site_name" content="Автовыкуп в Донецке. Работаем 24/7. Даем 95% рыночной цены" />
        <meta property="og:description" content="Автовыкуп в Донецке. Выкупим ваше авто по самой высокой цене быстро! Все виды оплат. Безопасная сделка, бесплатная оценка авто.  Платим сразу всю сумму. Работаем быстро." />
      </Head>
      <City city={city}>
        <p>
