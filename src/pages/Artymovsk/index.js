  ...
  return (
    <>
      ...
      <City city={city}>
        ...
        <h2>Кому интересен автовыкуп в Артемовске?</h2>
        <p>
        ...
        <p>2.	Отсутствие дополнительных расходов</p>
        ...
        <p>3.	Покупка автомобилей в любом техническом состоянии</p>
        ...
        <h3>Автовыкуп в Артемовске: что вы получите?</h3>
