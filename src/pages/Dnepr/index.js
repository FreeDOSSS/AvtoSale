...
const App= () => {
  ...
  return (
    <>
      <Head>
        <title>"Автовыкуп в Днепре. Работаем 24/7. Даем 95% рыночной цены"</title>
        <link rel="canonical" href="https://vykup.org/avtovykyp-dnepr" />
        <meta name="description" content="Автовыкуп в Днепре. Выкупим ваше авто по самой высокой цене быстро! Все виды оплат. Безопасная сделка, бесплатная оценка авто.  Платим сразу всю сумму. Работаем быстро." />
        <meta property="og:title" content="Автовыкуп в Днепре. Работаем 24/7. Даем 95% рыночной цены" />
        <meta property="og:type" content="website" />
        <meta property = "og:url" content="https://vykup.org/avtovykyp-dnepr" />
        <meta property="og:site_name" content="Автовыкуп в Днепре. Работаем 24/7. Даем 95% рыночной цены" />
        <meta property="og:description" content="Автовыкуп в Днепре. Выкупим ваше авто по самой высокой цене быстро! Все виды оплат. Безопасная сделка, бесплатная оценка авто.  Платим сразу всю сумму. Работаем быстро." />
      </Head>
      <City city={city}>
      <p>
