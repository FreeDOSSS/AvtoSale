...
function Menu() {
  var avtoDrop = function avtoDrop(_ref) {
    var city = _ref.city;
    console.log(city.sort(function (a, b) {
      return console.log("a.name < b.name", a.name < b.name);
    }));
  };

  avtoDrop(_router_router__WEBPACK_IMPORTED_MODULE_4__["default"]);
...
//# sourceMappingURL=index.js.4b0a1714ebac4032fc75.hot-update.js.map